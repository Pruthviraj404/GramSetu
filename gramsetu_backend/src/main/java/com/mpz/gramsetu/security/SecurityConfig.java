    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/auth/pending").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/auth/approve/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/auth/reject/**").hasRole("ADMIN")
